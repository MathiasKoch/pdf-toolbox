...
@XmlRootElement(name = "GetPortalSearchInfoResponse", namespace = "http://microsoft.com/webservices/OfficeServer/QueryService")
public class GetPortalSearchInfoResponse {

    @XmlElement(name = "GetPortalSearchInfoResult", namespace = "http://microsoft.com/webservices/OfficeServer/QueryService")
