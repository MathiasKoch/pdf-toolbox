...
@XmlType(name = "", propOrder = {
    "convertWebPartFormatResult"
})
@XmlRootElement(name = "ConvertWebPartFormatResponse")
public class ConvertWebPartFormatResponse {

    @XmlElement(name = "ConvertWebPartFormatResult")
    ...
    public String getConvertWebPartFormatResult() {
        return convertWebPartFormatResult;
    }
    ...
    public void setConvertWebPartFormatResult(String value) {
        this.convertWebPartFormatResult = value;
    }
