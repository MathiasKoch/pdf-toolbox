...
@XmlType(name = "", propOrder = {
    "getBindingResourceDataResult"
})
@XmlRootElement(name = "GetBindingResourceDataResponse")
public class GetBindingResourceDataResponse {

    @XmlElement(name = "GetBindingResourceDataResult")
    ...
    public String getGetBindingResourceDataResult() {
        return getBindingResourceDataResult;
    }
    ...
    public void setGetBindingResourceDataResult(String value) {
        this.getBindingResourceDataResult = value;
    }
